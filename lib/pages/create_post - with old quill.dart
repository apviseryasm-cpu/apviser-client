...
//       // List deltaJson = widget.postData!.descr!.toDelta().toJson();
//       _controller.document = Document.fromHtml(widget.postData!.descr!);
//       // QuillController(document: Document.fromDelta(Document.fromHtml(widget.postData!.descr!) as Delta),// "\n" is mandatory
...
//     // _controller =
//     //     QuillController(document: Document.fromJson([{'insert':postDetails['descr']+"\n" ?? '\n'}]),// "\n" is mandatory
//     //       selection: TextSelection.collapsed(offset: 0),
//     //     );
//     // List deltaJson = _controller.document.toDelta().toJson();
//     // _controller =
//     //     QuillController(document: Document.fromDelta(DeltaToHTML.encodeJson(postDetails['descr'] ?? '')),// "\n" is mandatory
//     //       selection: TextSelection.collapsed(offset: 0),
//     //     );
//     // _controller =
//     //     QuillController(document: Document.fromDelta(Document.fromHtml(postDetails['descr'] ?? '') as Delta),// "\n" is mandatory
//     //       selection: TextSelection.collapsed(offset: 0),
//     //     );
//     _controller.document = Document.fromHtml(postDetails['descr'] ?? '');
//
